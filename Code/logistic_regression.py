...
class LogReg:
    ...
    def top_feature_selection(self, X_validation, X_test):
        ...
        select = top_features.fit(self.X_train, self.y_train)
        chi_scores = select.scores_
    ...
    def accuracy_scores(self, y_data, y_pred):
        """
        Calculates the accuracy scores of test data and visualizes the confusion matrix as a heat map
        ...
        accuracy_testing = balanced_accuracy_score(y_data, y_pred)
